...
<br/> <!-- 스페이스를 주고싶으면 <br/>를 이용하는게 제일 편할 듯 -->
...
<div id="2"></div> 
<!-- 이 분은 각 division마다 div에 id를 줘서 나눈 것이였음 -->
<!-- 아~~ 윗 제목만 가운뎃 정렬 하고 싶었고 하단부분의 셀은 |:---| 해서 왼쪽 정렬 해버렸구나 개 쩐다-->
...
|                                   아키텍처(Architecture)                                   |
| :----------------------------------------------------------------------------------------: |
| <img src="./readme_assets/10.jpg" alt="아키텍처(Architecture)" width="1000px" /> |

|                              개체-관계 모델(ERD)                               |
| :----------------------------------------------------------------------------: |
| <img src="./readme_assets/11.jpg" alt="개체-관계 모델(ERD)" width="1000px" /> |
